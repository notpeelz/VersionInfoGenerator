...
Console.WriteLine("GitCommitterDate: " + VersionInfoTest.GitCommitterDate);
Console.WriteLine("GitAuthorDate: " + VersionInfoTest.GitAuthorDate);
...
Console.WriteLine("GitCommitterDate: " + json.GitCommitterDate);
Console.WriteLine("GitAuthorDate: " + json.GitAuthorDate);
